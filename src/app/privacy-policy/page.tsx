    ...
    <div className="container mx-auto px-4 py-12">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <p className="text-secondary-400 mb-6">
            To exercise these rights, please contact us at privacy@aioscompanion.com. Please note that some of these rights may be limited where we have compelling legitimate grounds or legal obligations to process your personal information.
          </p>
          
          <h2 className="text-2xl font-semibold text-secondary-500 mt-8 mb-4">10. Children's Privacy</h2>
          <p className="text-secondary-400 mb-6">
            Our Services are not intended for children under 16 years of age. We do not knowingly collect personal information from children under 16. If you are a parent or guardian and believe your child has provided us with personal information, please contact us immediately at privacy@aioscompanion.com, and we will take steps to delete such information.
          </p>
          ...
          <p className="text-secondary-400 mb-6">
            ...
            Email: privacy@aioscompanion.com
          </p>
        </div>
      </div>
    </div>
