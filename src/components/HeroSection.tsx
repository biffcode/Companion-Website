...
const HeroSection = () => {
  ...
  return (
    <section className="pt-24 pb-16 sm:pt-32 sm:pb-20 md:pt-40 md:pb-28 bg-neutral-50">
      <div className="container">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-center">
          ...
          >
            <h1 className="text-title text-3xl sm:text-4xl md:text-5xl lg:text-6xl">
            ...
            <ul className="space-y-3 sm:space-y-4">
              {[
                ...
                <li key={index} className="flex items-start">
                  <svg className="w-5 h-5 sm:w-6 sm:h-6 text-brand mt-1 mr-2 sm:mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  <span className="text-text-secondary text-base sm:text-lg md:text-xl font-medium">{point}</span>
                </li>
              ))}
            </ul>
